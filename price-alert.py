...
def get_price(url, selector):
    ...
    try:
         XPATH_SALE_PRICE = '//span[contains(@id,"ourprice") or contains(@id,"saleprice") or contains(@class,"a-size-medium a-color-price inlineBlock-display offer-price a-text-normal price3P") or contains(@id,"priceblock_ourprice")]/text()'
